    ...
    <div className="pb-12">
      <section className="animate-rise-in relative overflow-hidden rounded-[2.75rem] border border-white/10 bg-white/5 px-4 py-14 text-center shadow-[0_24px_80px_rgba(2,6,23,0.45)] backdrop-blur-md sm:px-8 sm:pb-20 sm:pt-20 md:px-12">
        <div className="relative mx-auto max-w-4xl space-y-6">
          <Badge className="animate-rise-in border-white/10 bg-white/6 text-neutral-300 [animation-delay:100ms]">
            Premium space for thoughtful writing
          </Badge>
          <h1 className="animate-rise-in font-display text-5xl font-bold leading-none tracking-tight text-white [animation-delay:180ms] sm:text-6xl md:text-7xl">
            Rivayat
          </h1>
      ...
      <section className="mx-auto mt-14 max-w-4xl space-y-5 sm:mt-16">
        <div className="space-y-2">
          ...
          <h2 className="animate-rise-in font-display text-3xl text-white [animation-delay:380ms]">
